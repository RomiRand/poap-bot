...
CREATE TABLE codes ( ID SERIAL PRIMARY KEY, code VARCHAR ( 50 ) NOT NULL, event_id TEXT, username TEXT NULL, is_active BOOLEAN DEFAULT TRUE, claimed_date timestamp NULL, created_date timestamp, CONSTRAINT UC_CODE UNIQUE (code, event_id));
